...
CREATE TABLE `adminactions` (
  ...
  `action_type` enum('Lock','Unlock') NOT NULL,
  `action_timestamp` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`action_id`),
  KEY `admin_id` (`admin_id`),
  CONSTRAINT `adminactions_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `adminactions` VALUES (1,1,'Lock','2024-11-07 13:04:23'),(2,1,'Unlock','2024-11-07 13:04:23');
